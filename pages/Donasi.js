...
export const Donasi = (params) => {
  ...
  return `
    ...
    <div class="container mx-auto py-10 px-4 max-w-6xl font-inter text-base-content">
            ...
            <div class="card bg-base-300 shadow-2xl rounded-[2.5rem] border border-white/5 flex flex-col overflow-visible">
                <div class="card-body p-8 md:p-10 flex-grow text-left">
                    <div class="flex items-center gap-4 mb-8">
                        ...
                        <h1 class="text-4xl font-black tracking-tighter font-poppins uppercase">Kirim Donasi</h1>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div class="form-control">
                            ...
                            <input type="text" id="donasi-nama" 
                                ...
                                class="input bg-base-100 border-base-content/10 w-full h-14 rounded-2xl font-bold focus:border-primary transition-all">
                        ...
                        <div class="form-control">
                            ...
                            <button type="button" onclick="window.openPaymentModal()" id="btn-pilih-metode" 
                        ...
                        <button type="button" onclick="window.prosesDonasi(event)" id="btn-submit-donasi" 
                            class="btn btn-primary w-full h-16 rounded-[1.5rem] text-xl font-black shadow-xl shadow-primary/20 mt-4 uppercase tracking-tighter text-white border-none">
                            Konfirmasi Donasi
                        </button>
                    </div>
                </div>
