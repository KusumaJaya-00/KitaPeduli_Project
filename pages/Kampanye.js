...
export const Kampanye = () => {
  ...
  return `
        <div class="space-y-10 py-10 px-4 md:px-10 lg:px-16 bg-base-200/30 min-h-screen font-inter">
            <!-- Menu Filter Kategori -->
            <div class="flex flex-wrap justify-center gap-2 sticky top-20 z-40 bg-base-100/50 backdrop-blur-md p-2 rounded-2xl border border-base-content/5 w-fit mx-auto shadow-sm">
            ...
            <!-- Grid Kampanye: Maksimal 4 Kolom -->
            <div id="campaign-grid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-w-[95rem] mx-auto min-h-[400px]">
